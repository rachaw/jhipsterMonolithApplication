...
To optimize the jhipsterMonolithApplication application for production, run:
...
Then navigate to [http://localhost:18082](http://localhost:18082) in your browser.
